...
public enum L10n {
    private static let simplifiedChinese: [String: String] = [
        ...
        "Done Selecting": "完成选择",
        "Edit Selected…": "批量编辑…",
        "Edit Selected Tasks": "批量编辑任务",
        "Change only the fields you choose": "仅修改所选字段",
        "Keep current": "保持原值",
        "Move to": "移动到",
        "Preview": "预览",
        "Tasks to change": "将修改的任务",
        "Tasks to move": "将移动的任务",
        "Additional Subtasks": "额外移动的子任务",
        "Moving a Task also moves its Subtasks. A Subtask moved without its parent becomes a top-level Task.": "移动任务会连同子任务一起移动；单独移动子任务时，它会成为目标位置的顶级任务。",
        "Apply Changes": "应用更改",
        "Selected destination is no longer active.": "所选目标项目已不再处于活动状态。",
        "Select All": "全选",
        "Deselect All": "取消全选",
        ...
        "Project workbook exported successfully.": "项目工作簿导出成功。",
        "Project import template saved successfully.": "项目导入模板保存成功。",
        "Project Import Preview": "项目导入预览",
        "Import Tasks into %@.": "将任务导入“%@”。",
        "Skip": "跳过",
        "Conflict": "冲突",
        "Resolve conflicts before importing.": "请先解决冲突再导入。",
        "And %d more conflicts.": "另有 %d 个冲突。",
        "Task ID belongs to Inbox or another Project.": "任务编号属于收件箱或其他项目。",
        "Task ID belongs to an item in Trash.": "任务编号属于废纸篓中的记录。",
        "Parent Task is not in this Project or workbook.": "父任务不在当前项目或工作簿中。",
        "A Task cannot be its own Parent Task.": "任务不能将自身设为父任务。",
        "Parent Task relationships contain a cycle.": "父任务关系中存在循环。",
        "Imported %d new Tasks and updated %d Tasks in %@.": "已在“%3$@”中新增 %1$d 个任务并更新 %2$d 个任务。",
        "Archive \"%@\"?": "归档“%@”？",
